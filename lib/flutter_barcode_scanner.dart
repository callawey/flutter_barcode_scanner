...
class FlutterBarcodeScanner {
  ...
  static Future<String> scanBarcode(String lineColor, String infoMessage, String cancelButtonText, bool isShowFlashIcon, ScanMode scanMode) async {
  ...
  static Stream? getBarcodeStreamReceiver(String lineColor, String infoMessage, String cancelButtonText, bool isShowFlashIcon, ScanMode scanMode) {
    if (cancelButtonText.isEmpty) {
      cancelButtonText = 'Cancel';
    }
